...
const skillMap = {
    ...
    "ArchsagesInsight": ArchsagesInsight,
    ...
    "Bloodlust": Bloodlust,
    "BloodlustPlus": BloodlustPlus,
    "BowRangePlusOne": BowRangePlusOne,
    ...
    "SwordRangePlusOne": SwordRangePlusOne,
    "Swordbreaker": Swordbreaker,
    "Swordfaire": Swordfaire,
    "Templar": Templar,
    "ThreeLeggedCrow": ThreeLeggedCrow,
    "Thunderstorm": Thunderstorm,
    "TomeRangePlusOne": TomeRangePlusOne,
    "TomeRangePlusTwo": TomeRangePlusTwo,
...
function DoubleLion(attacker, defender, info) {
    if (info.whoseSkill == 1) { return; }
    attacker.skillMsg += outputSkill("Double Lion");
