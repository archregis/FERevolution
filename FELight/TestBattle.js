...
on('chat:message', function(msg) {
    ...
    if (command == 'view') {
      ...
      let ResA = Number(getAttrByName(user.id, 'Restot'));
        ...
        let StrB = Number(getAttrByName(target.id, 'Dmgtot'));
        let MagB = Number(getAttrByName(target.id, 'MDmgtot'));
        let SklB = Number(getAttrByName(target.id, 'skl_total'));
        let SpdB = Number(getAttrByName(target.id, 'Atkspd'));
        let LckB = Number(getAttrByName(target.id, 'lck_total'));
        let DefB = Number(getAttrByName(target.id, 'Protot'));
        let ResB = Number(getAttrByName(target.id, 'Restot'));
